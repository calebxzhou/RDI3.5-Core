...
public abstract class Transition implements Cloneable {
     ...
     * For example, a transition that resizes objects on the screens may wish
     ...
     * region in screens coordinates of the epicenter of the transition.
     *
     * @see #setEpicenterCallback(EpicenterCallback)
     */
    @FunctionalInterface
    public interface EpicenterCallback {
        ...
        /**
         * Implementers must override to return the epicenter of the Transition in screens
