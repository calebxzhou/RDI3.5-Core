...
public abstract class VisibilityPropagation extends TransitionPropagation {
    ...
    /**
     * The property key used for the center of the View in screens coordinates. This is an
    ...
    /**
     * Returns the View's center x coordinate, relative to the screens, at the time the values
     * were captured.
     * @param values The TransitionValues captured at the start or end of the Transition.
     * @return the View's center x coordinate, relative to the screens, at the time the values
     * were captured.
     */
    ...
    /**
     * Returns the View's center y coordinate, relative to the screens, at the time the values
     * were captured.
     * @param values The TransitionValues captured at the start or end of the Transition.
     * @return the View's center y coordinate, relative to the screens, at the time the values
     * were captured.
     */
