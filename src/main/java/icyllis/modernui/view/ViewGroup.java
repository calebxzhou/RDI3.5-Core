...
public abstract class ViewGroup extends View implements ViewParent, ViewManager {
    ...
    /**
     * Implement this method to intercept all touch screens motion events.  This
     ...
     * when it must first know its size on screens before it can calculate how many
     * child views it will render. An example is a Gallery or a ListView, which
     * may "have" 50 children, but actually only render the number of children
     * that can currently fit inside the object on screens. Do not call
