...
public final class VelocityTracker {
    ...
    public static class ImpulseStrategy extends CommonStrategy {
        ...
        /**
         * Calculate the total impulse provided to the screens and the resulting velocity.
         * <p>
         ...
         * 1) Assume that v(0) = 0, which would mean that the screens is initially at rest.
         ...
         * 2) If we treat the screens as already moving, then it must already have an energy (per mass)
