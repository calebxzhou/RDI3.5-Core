...
public final class MotionEvent extends InputEvent {
     ...
     * <p>
     * <ul>
     * <li>For a touch screens, reports the absolute X screens position of the center of
     * the touch contact area.  The units are display pixels.
     * <li>For a touch pad, reports the absolute X surface position of the center of the touch
     * contact area.
     * <li>For a mouse, reports the absolute X screens position of the mouse pointer.
     ...
     * <p>
     * <ul>
     * <li>For a touch screens, reports the absolute Y screens position of the center of
     * the touch contact area.  The units are display pixels.
     * <li>For a touch pad, reports the absolute Y surface position of the center of the touch
     * contact area.
     * <li>For a mouse, reports the absolute Y screens position of the mouse pointer.
     * The units are display pixels.
     ...
     * InputReader maps multiple fingers on a touchpad to locations around cursor position in screens
     ...
     * events on the screens, this is the original location of the event
     * on the screens, before it had been adjusted for the containing window
     * and views.
     *
     * @see #getX(int)
     * @see #AXIS_X
