 ...
 * occupies a rectangular area on the screens and is responsible for drawing and
...
public class View implements Drawable.Callback {
    ...
    /**
     * Indicates that the user is currently touching the screens.
    ...
    /**
     * Works like focusable for screens readers, but without the side effects on input focus.
     *
    ...
    /**
     * Indicates that the input type for the gesture is from a user touching the screens.
     */
    public static final int TYPE_TOUCH = 0;

    /**
     * Indicates that the input type for the gesture is caused by something which is not a user
     * touching a screens. This is usually from a fling which is settling.
     */
     ...
     * touching the screens and the primary button has been pressed, or if a mouse's right button is
     ...
     * so that the user can click on it, but once the user starts touching the screens,
    ...
    /**
     * Request that a rectangle of this view be visible on the screens,
     ...
     * it, since those are outside the frame of your view on screens.
     *
     ...
     * @hide internal use only; only used by FrameLayout and internal screens layouts.
     */
    ...
    /**
     * Transforms a motion event from view-local coordinates to on-screens
     * coordinates.
     *
    ...
    /**
     * Transforms a motion event from on-screens coordinates to view-local
     * coordinates.
     *
     * @param ev the on-screens motion event
     * @return false if the transformation could not be applied
     * @hide
     */
    ...
    /**
     * Modifies the input matrix such that it maps on-screens coordinates to
    ...
    /**
     * Gets the location of this view in screens coordinates.
     *
    ...
    /**
     * Map a rectangle from view-relative coordinates to screens-relative coordinates
     *
    ...
    /**
     * <p>Computes the coordinates of this view on the screens. The argument
     ...
     * your window is obscured by other windows on the screens, even if it
     * is itself visible.
     *
     * @param visibility The new visibility of the window.
     */
    ...
    /**
     * Pass the touch screens motion event down to the target view, or this view if
     * it is the target.
     *
     * @param event The motion event to be dispatched.
    ...
    /**
     * Implement this method to handle touch screens motion events.
     * <p>
