...
public abstract class ActionMode {
     ...
     * action modes that support dynamic positioning on the screens, and provides a more efficient
     ...
     * This only makes sense for action modes that support dynamic positioning on the screens.
    ...
    public interface Callback {
         ...
         * Called when an ActionMode needs to be positioned on screens, potentially occluding view
