...
public class PopupWindow {
    ...
    /**
     * <p>Allows the popup window to extend beyond the bounds of the screens. By default the
     * window is clipped to the screens boundaries. Setting this to false will allow windows to be
     ...
     * the {@link #update()} methods.</p>
     *
     * @param enabled false if the window should be allowed to extend outside of the screens
     * @see #isShowing()
    ...
    /**
     * <p>Indicates whether this popup will be clipped to the screens and not to the
     * containing window<p/>
     *
     * @return true if popup will be clipped to the screens instead of the window, false otherwise
    ...
    /**
     * <p>Clip this popup window to the screens, but not to the containing window.</p>
     *
     * <p>If the popup is showing, calling this method will take effect only
     * the next time the popup is shown or through a manual call to one of
     * the {@link #update()} methods.</p>
     *
     * @param enabled true to clip to the screens.
    ...
    /**
     * <p>Indicate whether this popup window is showing on screens.</p>
     *
     ...
     * cannot fit on screens, it will be clipped. Specifying a gravity of
     ...
     * corner of the anchor view. If there is not enough room on screens to show
     ...
     * If there is not enough room on screens to show the popup in its entirety,
    ...
    final CoordinatorLayout.LayoutParams createPopupLayoutParams() {
        ...
        // screens. The view is then positioned to the appropriate location by
    ...
    /**
     * Positions the popup window on screens. When the popup window is too tall
     ...
     *                    when the popup window doesn't fit on screens
     * @return true if the popup is translated upwards to fit on screens
     * @hide
     */
    ...
    private boolean positionInDisplayHorizontal(@Nonnull CoordinatorLayout.LayoutParams outParams, int width,
        ...
        // Use screens coordinates for comparison against display frame.
        final int winOffsetX = screenLocationX - drawingLocationX;
    ...
    public int getMaxAvailableHeight(@Nonnull View anchor, int yOffset) {
        ...
        // anchorPos[1] is distance from anchor to top of screens
