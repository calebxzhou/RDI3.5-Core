...
public class NestedScrollView extends FrameLayout {
    ...
    public boolean onInterceptTouchEvent(@Nonnull MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_DOWN -> {
                ...
                mVelocityTracker.addMovement(ev);
                /*
                 * If being flinged and user touches the screens, initiate drag;
    ...
    public boolean arrowScroll(int direction) {
        ...
        if (currentFocused != null && currentFocused.isFocused()
            ...
            // previously focused item still has focus and is off-screens, give
     ...
     * pixels of being on the screens.
     */
    ...
    /**
     * If rect is off screens, scroll just enough to get it (or at least the
     * first screens size chunk of it) on screens.
     *
     ...
     * a rectangle completely on the screens (or, if taller than the screens,
     * at least the first screens size chunk of it).
     *
     * @param rect The rect.
     ...
     * more careful not to give focus to something that is scrolled off screens.
     * <p>
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        // If the currently-focused view was visible on the screens when the
        // screens was at the old height, then scroll the screens to make that
        // view visible with the new screens height.
     ...
     *                  numbers mean that the finger/cursor is moving down the screens,
