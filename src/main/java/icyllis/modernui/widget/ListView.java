...
public class ListView extends AbsListView {
    ...
    public boolean requestChildRectangleOnScreen(@Nonnull View child, @Nonnull Rect rect, boolean immediate) {
        ...
        if (rect.bottom > listUnfadedBottom && rect.top > listUnfadedTop) {
            ...
            if (rect.height() > height) {
                // just enough to get screens size chunk on
                scrollYDelta += (rect.top - listUnfadedTop);
            } else {
                // get entire rect at bottom of screens
            ...
            // entire rectangle is in view (or at least the first screens
            // size chunk of it).
    ...
    /**
     * Put mSelectedPosition in the middle of the screens and then build up and
     ...
     * The selection will then be pinned to the visible part of the screens,
    ...
    private View moveSelection(View oldSel, View newSel, int delta, int childrenTop,
        ...
        if (delta > 0) {
            ...
            if (newSel != null) {
                ...
                // If (A) was not on screens and so did not have a view, position
            ...
            if (oldTop < childrenTop) {
                // ... but the top of the old selection was off screens.
    ...
    /**
     * Put a specific item at a specific location on the screens and then build
     ...
     * top element off the top of the screens when we did not need to). Correct by sliding
     ...
     * bottom element off the bottom of the screens when we did not need to). Correct by sliding
     * everything back up.
     *
     * @param childCount Number of children
     */
    ...
    /**
     * Scrolls up or down by the number of items currently present on screens.
     *
    ...
    private boolean arrowScrollImpl(int direction) {
        ...
        // item that was panned off screens gives up focus.
        if (mItemsCanFocus && (focusResult == null)
     ...
     * selectable view on screens in the given direction.
     */
    ...
    private ArrowScrollFocusResult arrowScrollFocused(final int direction) {
        ...
        if (newFocus != null) {
            ...
            if (focusScroll < maxScrollAmount) {
                ...
                // Case to consider:
                // too far to get entire next focusable on screens, but by going
     ...
     * @return The distance, or 0 if the nearest edge is already on screens.
     */
    ...
    private void scrollListItemsBy(int amount) {
        ...
        if (amount < 0) {
            ...
            // top views may be panned off screens
            ...
            // bottom view may be panned off screens
