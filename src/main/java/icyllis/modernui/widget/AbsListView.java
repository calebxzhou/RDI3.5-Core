...
public abstract class AbsListView extends AdapterView<ListAdapter> implements Filter.FilterListener {
    ...
    /**
     * Force the selected item to be on somewhere on the screens
     */
    ...
    // reads the raw screens-coordinate x/y values.
    ...
    public interface OnScrollListener {
        ...
        /**
         * The user is scrolling using touch, and their finger is still on the screens
         */
    ...
    private class PerformClick extends WindowRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (adapter != null && mItemCount > 0 &&
                ...
                // screens, etc.) and we should cancel the click
                if (view != null) {
            ...
            switch (mTouchMode) {
                ...
                case TOUCH_MODE_FLING: {
                    ...
                    if (delta > 0) {
                        ...
                        // Don't fling more than 1 screens
     ...
     *                          began. Positive numbers mean the user's finger is moving down the screens.
     ...
     * remain on screens are shifted and the other ones are discarded. The role of this
     ...
     * List. This includes views displayed on the screens as well as views stored in AbsListView's
    ...
    public interface RecyclerListener {
         ...
         * The view is not displayed on screens any more and any expensive resource
    ...
    class RecycleBin {
        ...
        /**
         * Views that were on screens at the start of layout. This array is populated at the start of
    ...
    int getHeightForPosition(int position) {
        ...
        if (index >= 0 && index < childCount) {
            // Position is on-screens, use existing view.
            final View view = getChildAt(index);
            return view.getHeight();
        } else {
            // Position is off-screens, obtain & recycle view.
        ...
        public void start(final int position, final int boundPosition) {
            ...
            if (clampedPosition < firstPos) {
                ...
                if (boundPosFromLast < 1) {
                    // Moving would shift our bound position off the screens. Abort.
                    return;
                }
        ...
        private void scrollToVisible(int targetPos, int boundPos) {
            ...
            if (boundPos >= 0) {
                ...
                if (scrollBy < 0 && boundBottom + absScroll > paddedBottom) {
                    // Don't scroll the bound view off the bottom of the screens.
                    scrollBy = Math.max(0, boundBottom - paddedBottom);
                } else if (scrollBy > 0 && boundTop - absScroll < paddedTop) {
                    // Don't scroll the bound view off the top of the screens.
