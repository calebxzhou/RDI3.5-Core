...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    public boolean bringPointIntoView(int offset) {
        ...
        // we want to scroll to keep the line-right on the screens, as other
    ...
    public boolean moveCursorToVisibleOffset() {
        ...
        // First: make sure the line is visible on screens:
        ...
        // Next: make sure the character is visible on screens:
     ...
     *
     * @param x The horizontal absolute position of a point on screens
     * @param y The vertical absolute position of a point on screens
