...
public class Window implements AutoCloseable {
     ...
     * window; it is placed at the top of the screens.
     * In multiuser systems shows on all users' windows.
     */
     ...
     * <p>
     * In multi-user systems shows only on the owning user's screens.
     */
     ...
     * in virtual screens coordinate system.
     *
    ...
    /**
     * Returns the window width in virtual screens coordinates.
     *
     * @return window width
     */
    ...
    /**
     * Returns the window height in virtual screens coordinates.
     *
    ...
    public enum State {
        /**
         * The window is movable and takes up a subsection of the screens.
         */
        WINDOWED,
         ...
         * fill the screens at the native desktop resolution.
         */
