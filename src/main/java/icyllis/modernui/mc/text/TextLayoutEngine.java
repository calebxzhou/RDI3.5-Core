...
public class TextLayoutEngine {
     ...
     * the fly
     * as a performance boost. The speed up is most noticeable on the F3 screens which rapidly displays lots of changing
     * numbers.
    ...
    private Entry getOrCacheString(@Nonnull String str) {
         ...
         * This will apply color codes in the string's logical character order and not the visual order on screens.
         */
   ...
   /* @Deprecated
     ...
     * glyph on
     * the fly. This special digit handling gives a significant speedup on the F3 debug screens.
     */
    @Deprecated
