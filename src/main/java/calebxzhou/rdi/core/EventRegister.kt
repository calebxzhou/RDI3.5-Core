...
import calebxzhou.rdi.core.misc.ClientMobSpawner
import calebxzhou.rdi.core.misc.HwSpec
import calebxzhou.rdi.core.misc.KeyBinds
import calebxzhou.rdi.core.util.NetworkUtils
import calebxzhou.rdi.core.util.PlayerUtils
    ...
    private fun animalSex(player: LocalPlayer) {
        ...
        if (player.isCrouching) {
            ...
            PlayerUtils.displayClientMessage(
                player,
                "动物繁殖进度 ${sexTickAmount}/${sexTickAmountNeedToAdult}",
                true
            )
